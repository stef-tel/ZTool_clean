...
"}")
        ...
        self.billingPreviewProgressBar = QtWidgets.QProgressBar(self.frame_5)
        self.billingPreviewProgressBar.setProperty("value", 0)
        self.billingPreviewProgressBar.setInvertedAppearance(False)
        self.billingPreviewProgressBar.setObjectName("billingPreviewProgressBar")
        self.gridLayout.addWidget(self.billingPreviewProgressBar, 1, 0, 1, 1)
        self.stepLabel = QtWidgets.QLabel(self.frame_5)
        self.stepLabel.setObjectName("stepLabel")
        self.gridLayout.addWidget(self.stepLabel, 2, 0, 1, 1)
        self.gridLayout_8.addWidget(self.frame_5, 0, 2, 1, 1)
        self.wizardStackedWidget.addWidget(self.billingPage)
        self.extendPage = QtWidgets.QWidget()
        self.extendPage.setObjectName("extendPage")
        self.wizardStackedWidget.addWidget(self.extendPage)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.stepLabel.setText(_translate("MainWindow", "Press \"Launch Billing Preview button\""))
